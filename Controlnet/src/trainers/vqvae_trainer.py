...
class VQVAETrainer:
    def __init__(self, args):
        ...
        self.perceptual_loss = PerceptualLoss(
            spatial_dims=args.spatial_dimension, network_type="squeeze", is_fake_3d=True
        )
        ...
        self.optimizer_d = torch.optim.Adam(params=self.discriminator.parameters(), lr=args.discriminator_learning_rate)
        ...
        checkpoint_path = self.run_dir / "checkpoint.pth" #changed from checkpoint.pth
    ...
    def train_epoch(self, epoch):
        ...
        for step, batch in progress_bar:
            ...
            if reconstruction.shape[2:] != images.shape[2:]: ###
                reconstruction = F.interpolate(reconstruction, images.shape[2:],mode="trilinear") ##added this part
